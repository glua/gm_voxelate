...
LUA_FUNCTION_STATIC( tostring )
{
	...
	lua_pushfstring( LUA->GetState(), sn_bf_common::tostring_format, metaname, buf );
...
LUA_FUNCTION_STATIC( WriteBitAngle )
{
	...
	if( bits < 0 )
		sn_bf_common::ThrowError( LUA, "invalid number of bits to write (%d is less than 0)", bits );
